...
enum ModuleCatalog {
    static let console: [ModuleEntry] = [
        ...
        ModuleEntry("activities", "Actividades", "📝", "/console/activities"),
        ModuleEntry("my-activities", "Mis actividades", "📝", "/console/my-activities"),
        ModuleEntry("evidences", "Evidencias", "📷", "/console/evidences"),
        ModuleEntry("my-evidences", "Mis evidencias", "📷", "/console/my-evidences"),
        ModuleEntry("viatics", "Viáticos", "💼", "/console/viatics"),
        ModuleEntry("my-viatics", "Mis viáticos", "💼", "/console/my-viatics"),
        ModuleEntry("vehicles", "Vehículos", "🚗", "/console/vehicles"),
        ModuleEntry("my-vehicles", "Mis vehículos", "🚗", "/console/my-vehicles"),
        ModuleEntry("gps", "GPS", "🗺️", "/console/gps"),
        ModuleEntry("tools", "Herramientas", "🧰", "/console/tools"),
        ModuleEntry("clients", "Clientes", "🤝", "/console/clients"),
        ModuleEntry("service-clients", "Clientes de servicio", "🧾", "/console/service-clients"),
        ModuleEntry("projects", "Proyectos", "🧩", "/console/projects"),
        ModuleEntry("work-projects", "Proyectos internos", "🧱", "/console/work-projects"),
        ...
        ModuleEntry("assets", "Activos", "📦", "/console/assets"),
        ...
        ModuleEntry("production", "Producción", "⚙️", "/console/production"),
        ModuleEntry("manufacturing", "Manufactura", "🏗️", "/console/manufacturing"),
        ModuleEntry("maintenance", "Mantenimiento", "🔧", "/console/maintenance"),
        ModuleEntry("quality", "Calidad", "✅", "/console/quality"),
        ModuleEntry("safety", "Seguridad", "🦺", "/console/safety"),
        ModuleEntry("workflow", "Flujos", "🔗", "/console/workflow"),
        ModuleEntry("service-sheets", "Hojas de servicio", "📄", "/console/service-sheets"),
        ModuleEntry("documents", "Documentos", "📁", "/console/documents"),
        ModuleEntry("cvs", "CVs", "📑", "/console/cvs"),
        ModuleEntry("client-tickets", "Tickets de clientes", "🎫", "/console/client-tickets"),
    ...
    static let contabilidad: [ModuleEntry] = [
        ...
        ModuleEntry("capital", "Capital", "💰", "/contabilidad/capital"),
