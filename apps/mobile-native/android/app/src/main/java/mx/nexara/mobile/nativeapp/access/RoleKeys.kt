...
/**
 * Clave canónica de rol — espejo de `apps/api/src/common/rbac/roles.v2.ts`
 * (`ROLES`, `LEGACY_TO_V2`) y de los nombres visibles de `ROLE_LABELS.es`.
 *
...
object RoleKeys {
    ...
    val ALL: List<String> = listOf(
        SUPER_ADMIN, CEO, ARQUITECTO, DIR_OPERACIONES, DIR_ADMIN, COORD_ADMIN,
        ADMINISTRATIVO, COORD_OPERACIONES, ING_CAMPO, ING_SOPORTE, COORD_VENTAS,
        VENDEDOR, LIDER_DISENO, DISENADOR, RH, CONTABILIDAD, CLIENTE, SUCURSAL,
    )
