...
fun TicketsTicketDetailScreen(
    ...
    Column(
        ...
        Text(t.titulo ?: "Ticket #${t.id}", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
        ...
        Card(
            ...
            Column(Modifier.padding(14.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                Text("Prioridad: ${t.displayPriority()}", style = MaterialTheme.typography.bodyMedium)
                Text("Asignación: ${t.fechaAsignacion?.take(16) ?: "—"}", style = MaterialTheme.typography.bodySmall)
                Text("Inicio: ${t.fechaInicio?.take(16) ?: "—"}", style = MaterialTheme.typography.bodySmall)
                Text("Cierre: ${t.fechaFinalizacion?.take(16) ?: "—"}", style = MaterialTheme.typography.bodySmall)
                if (t.isOpen()) {
                    Text(
