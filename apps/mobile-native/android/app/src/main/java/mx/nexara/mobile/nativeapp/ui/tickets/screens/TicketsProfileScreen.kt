    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        PullToRefreshBox(
            ...
            Column(
                ...
                Text("Perfil del portal", style = MaterialTheme.typography.titleLarge, fontWeight = FontWeight.Bold)
                Text(
                    if (editable) "Actualiza datos de contacto y dirección" else "Perfil de sucursal (solo lectura)",
                ...
                NxPanelShell(contentPadding = PaddingValues(14.dp)) {
                    Text("Contacto", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.SemiBold, color = MaterialTheme.colorScheme.primary)
                ...
                NxPanelShell(contentPadding = PaddingValues(14.dp)) {
                    Text("Dirección", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.SemiBold, color = MaterialTheme.colorScheme.primary)
                    Spacer(Modifier.height(8.dp))
                    OutlinedTextField(
                        value = state.address,
