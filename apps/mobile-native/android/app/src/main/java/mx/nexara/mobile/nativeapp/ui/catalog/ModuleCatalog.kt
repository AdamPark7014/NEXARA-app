...
object ModuleCatalog {
    ...
    val console: List<ModuleEntry> = listOf(
        ...
        mod("work-projects", "Proyectos internos", "🧱", "/operacion/work-projects", ParityStatus.SOLO_LECTURA),
        ...
        mod("employee-payments", "Pagos a empleados", "💵", "/console/employee-payments", ParityStatus.SOLO_LECTURA),
    ...
    val contabilidad: List<ModuleEntry> = listOf(
        ...
        mod("employee-payments", "Pagos a empleados", "💵", "/contabilidad/employee-payments", ParityStatus.SOLO_LECTURA),
        ...
        mod("work-projects", "Proyectos internos", "🧱", "/contabilidad/work-projects", ParityStatus.SOLO_LECTURA),
