...
export const config = {
  matcher: [
     ...
     */
    '/((?!_next/static|_next/image|_next/webpack-hmr|favicon.ico|icon.png|icon-48.png|icon-192.png|apple-touch-icon.png|apple-icon.png|brand/|robots.txt|sitemap.xml).*)',
  ],
};
