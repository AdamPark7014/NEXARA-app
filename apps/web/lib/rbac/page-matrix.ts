...
export const CORE_OLA1_PAGE_PATHS: PageRule[] = [
  ...
  '/erp/actividades/diarias/**',
  '/erp/activities/diarias',
  '/erp/activities/diarias/**',
  '/erp/activities/tareas',
  '/erp/activities/tareas/**',
  '/erp/activities/projects',
  '/erp/activities/projects/**',
  '/erp/activities/servicios',
  '/erp/activities/servicios/**',
...
export const PAGE_MATRIX: Record<RoleKey, PageRule[]> = {
  ...
  // ─── ENC. SOPORTE — coordina soporte; mismas páginas base que soporte ──
  [ROLES.ENC_SOPORTE]: [
    ...CORE_RECURSOS_PATHS,
    '/ops/my-activities',
    '/ops/my-activities/**',
