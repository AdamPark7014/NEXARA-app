...
export const MODULE_GUIDES: Record<ModuleId, ModuleGuide> = {
  ...
  'erp-contabilidad': {
    id: 'erp-contabilidad',
    summary: `Escritorio de la contadora: por cobrar, por pagar, facturas, conciliación, pre-nómina y cierres.`,
    ...
    connects: `accounting, invoicing, banking, employee-payments, expenses, audit`,
  },
  'accounting': {
    id: 'accounting',
