    ...
    <RoleGuard permissions={[PERMISSIONS.COTIZACIONES_ACCESS]}>
      ...
      <style jsx>{`
        ...
        .statCard {
          ...
          border: 1px solid rgba(78, 145, 220, 0.22);
          padding: 14px 16px;
          border-radius: 14px;
          display: grid;
          gap: 6px;
        ...
        .statCard.accent {
          background: linear-gradient(130deg, rgba(31, 140, 255, 0.28), rgba(11, 26, 46, 0.9));
        ...
        .quoteHeader {
          ...
          padding: 24px;
          border-radius: 18px;
          background: linear-gradient(120deg, rgba(15, 76, 129, 0.65), rgba(7, 18, 34, 0.85));
          border: 1px solid var(--quote-border);
          box-shadow: 0 18px 40px rgba(9, 23, 44, 0.45);
        }
        ...
        .primaryButton {
          ...
          color: #fff;
          box-shadow: 0 10px 24px rgba(31, 140, 255, 0.35);
        }
        ...
        .previewCard {
          ...
          border: 1px solid rgba(61, 130, 210, 0.2);
          padding: 20px;
          box-shadow: 0 20px 34px rgba(6, 16, 32, 0.45);
        }
        ...
        .tableRow {
          ...
          grid-template-columns:
            50px 140px 220px 140px 160px 140px 110px 90px 110px 80px 80px 80px 80px 130px 110px;
          gap: 8px;
          align-items: center;
        }
        ...
        .signatureBox {
          ...
          height: 60px;
          border-radius: 10px;
          border: 1px dashed rgba(230, 240, 255, 0.4);
          display: grid;
          place-items: center;
          font-size: 12px;
          color: rgba(230, 240, 255, 0.7);
