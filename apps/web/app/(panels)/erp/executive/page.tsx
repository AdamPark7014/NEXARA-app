      ...
      >
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
          ...
          <KpiCard
            ...
            hint={data ? `${data.maintenance?.upcomingVisits ?? 0} visitas próximas (30d)` : "contratos activos"}
            icon="🛠️"
          />
        </div>
      </Section>
      ...
      >
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
          ...
          <KpiCard
            ...
            variant={data && ((data.procurement?.pendingRequisitions ?? 0) + (data.procurement?.pendingPOs ?? 0)) > 5 ? "warning" : "default"}
            icon="🛒"
          />
          <KpiCard
            label="Stock crítico"
            ...
            variant={data && (data.procurement?.lowStockItems ?? 0) > 0 ? "warning" : "positive"}
            icon="📦"
          />
          <KpiCard
            label="Top vendedor"
