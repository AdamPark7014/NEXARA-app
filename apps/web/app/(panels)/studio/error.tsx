  ...
  return (
    <div style={{ padding: "40px 32px", maxWidth: 720, margin: "0 auto", fontFamily: "var(--nx-font-ui, system-ui)" }}>
      <div style={{ padding: 24, borderRadius: 14, background: "color-mix(in srgb, #ef4444 8%, #fff)", border: "1px solid color-mix(in srgb, #ef4444 25%, #e5e7eb)" }}>
        <h2 style={{ margin: "0 0 8px", fontSize: 18, fontWeight: 700, color: "#b91c1c" }}>Error en Studio</h2>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <Link href="/studio" style={{ padding: "8px 18px", borderRadius: 8, border: "1px solid #0f6ad6", color: "#0f6ad6", fontSize: 13, fontWeight: 600, textDecoration: "none" }}>
            Ir al inicio
          </Link>
        </div>
      </div>
