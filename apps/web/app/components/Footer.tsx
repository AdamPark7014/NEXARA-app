      ...
      <div className={styles.footerInner}>
        <div className={styles.mainGrid}>
          ...
          <div className={styles.brandCol}>
            <h3 className={styles.brandName}>NEXARA</h3>
            <p className={styles.brandTagline}>
              Tecnología que sostiene tu operación. Ingeniería de campo, ejecución y resultados medibles.
            </p>
          ...
          {/* Compañía */}
          <nav className={styles.linkCol} aria-label="Compañía">
          ...
          <nav className={styles.linkCol} aria-label="Legal">
            ...
            <ul className={styles.list}>
              ...
              <li><Link href="/legal/marca">Marca</Link></li>
            </ul>
          </nav>
        </div>
        ...
        <div className={styles.contactRow}>
          <button
            ...
            onClick={() => void openExternalUrl("mailto:ventas@nexara.com.mx")}
          >
            <span className={styles.contactIcon}><Icon.Mail /></span>
            <span className={styles.contactInfo}>
              <span className={styles.contactLabel}>Ventas</span>
              <span className={styles.contactValue}>ventas@nexara.com.mx</span>
            </span>
          </button>
          <button
            type="button"
            className={styles.contactBlock}
            onClick={() => void openExternalUrl("https://wa.me/5215536505044")}
          >
            <span className={styles.contactIcon}><Icon.WhatsApp /></span>
            <span className={styles.contactInfo}>
              <span className={styles.contactLabel}>WhatsApp</span>
              <span className={styles.contactValue}>+52 1 55 3650 5044</span>
            </span>
          </button>
        </div>

        <section className={styles.mapSection} aria-label="Ubicacion de Nexara">
          <div className={styles.mapHeader}>
            <h4 className={styles.mapTitle}>Ubicacion</h4>
            <p className={styles.mapAddress}>Explanada Puebla, Santiago Momoxpan, Puebla, Mexico</p>
          </div>
        ...
        <div className={styles.bottomBar}>
          <span>© {new Date().getUTCFullYear()} NEXARA. Todos los derechos reservados.</span>
