...
const items: QA[] = [
  { q: "¿Cuáles son nuestros servicios?", category: "Servicios", a: "Ofrecemos una amplia gama de soluciones tecnológicas: Cableado estructurado, Control de acceso, Videovigilancia, Comunicaciones, Servidores, Señalización digital, Seguridad inteligente, Desarrollo de software a medida, Diseño y desarrollo de páginas web, Aplicaciones móviles y de escritorio, además de integración de soluciones (infraestructura, energía, centros de datos, redes y ciberseguridad), así como consultoría y soporte especializado." },
  ...
  { q: "¿Tienen soporte post-venta?", category: "Soporte", a: "Sí, brindamos soporte post-venta, mantenimiento preventivo/correctivo y capacitación cuando se requiere." },
